...
export interface DetailGridItem extends PerformanceMetrics {
  ...
  planner: string;
  styleCode: string;
  factoryName: string;          // 대표 공장명
  reorderRound: number;         // 리오더 차수
  thisWeekReorderQty: number;   // 이번주 리오더 수량
  fourWeekReorderQty: number;   // 4주 리오더 수량
...
export interface ReorderConfirmItem {
  ...
  reorderRound?: number;     // 리오더 차수
  isConfirmed?: boolean;     // 최종확정 여부
  confirmedAt?: string;      // 확정 시각
}
...
export const MOCK_DETAIL_ITEMS: DetailGridItem[] = [
  // ── SS26 니트류 ──
  { id: 'D-001', year: 2026, season: 'SS26', garmentType: '니트류', itemName: '에어리 쿨링 반팔니트', planner: '김지현', styleCode: 'SP26S-KNT-001', factoryName: '닝보(홍화)', reorderRound: 1, thisWeekReorderQty: 310, fourWeekReorderQty: 1240,
  ...
  { id: 'D-002', year: 2026, season: 'SS26', garmentType: '니트류', itemName: '크루넥 서머 니트', planner: '김지현', styleCode: 'SP26S-KNT-002', factoryName: '닝보(아이비)', reorderRound: 1, thisWeekReorderQty: 215, fourWeekReorderQty: 860,
  ...
  // ── SS26 우븐 ──
  { id: 'D-003', year: 2026, season: 'SS26', garmentType: '우븐', itemName: '스트라이프 옥스포드 셔츠', planner: '이수민', styleCode: 'SP26S-WVN-001', factoryName: '탕콤', reorderRound: 0, thisWeekReorderQty: 170, fourWeekReorderQty: 680,
  ...
  { id: 'D-004', year: 2026, season: 'SS26', garmentType: '우븐', itemName: '린넨 블렌드 반팔셔츠', planner: '이수민', styleCode: 'SP26S-WVN-002', factoryName: '탕콤', reorderRound: 1, thisWeekReorderQty: 263, fourWeekReorderQty: 1052,
  ...
  // ── SS26 저지 ──
  { id: 'D-005', year: 2026, season: 'SS26', garmentType: '저지', itemName: '오버핏 반팔 티셔츠', planner: '박준영', styleCode: 'SP26S-JSY-001', factoryName: '닝보(홍화)', reorderRound: 2, thisWeekReorderQty: 525, fourWeekReorderQty: 2100,
  ...
  { id: 'D-006', year: 2026, season: 'SS26', garmentType: '저지', itemName: '피그먼트 워싱 반팔티', planner: '박준영', styleCode: 'SP26S-JSY-002', factoryName: '닝보(아이비)', reorderRound: 0, thisWeekReorderQty: 145, fourWeekReorderQty: 580,
  ...
  // ── SS26 데님 ──
  { id: 'D-007', year: 2026, season: 'SS26', garmentType: '데님', itemName: '스트레이트 데님 팬츠', planner: '최서윤', styleCode: 'SP26S-DNM-001', factoryName: '탕콤', reorderRound: 1, thisWeekReorderQty: 230, fourWeekReorderQty: 920,
  ...
  { id: 'D-008', year: 2026, season: 'SS26', garmentType: '데님', itemName: '와이드 핏 데님', planner: '최서윤', styleCode: 'SP26S-DNM-002', factoryName: '닝보(홍화)', reorderRound: 0, thisWeekReorderQty: 185, fourWeekReorderQty: 740,
  ...
  // ── SS26 아우터 ──
  { id: 'D-009', year: 2026, season: 'SS26', garmentType: '아우터', itemName: '라이트 윈드브레이커', planner: '한도윤', styleCode: 'SP26S-OTR-001', factoryName: '닝보(아이비)', reorderRound: 0, thisWeekReorderQty: 105, fourWeekReorderQty: 420,
  ...
  // ── FW25 니트류 ──
  { id: 'D-010', year: 2025, season: 'FW25', garmentType: '니트류', itemName: '터틀넥 울 니트', planner: '김지현', styleCode: 'SP25F-KNT-003', factoryName: '닝보(홍화)', reorderRound: 0, thisWeekReorderQty: 395, fourWeekReorderQty: 1580,
  ...
  { id: 'D-011', year: 2025, season: 'FW25', garmentType: '니트류', itemName: '케이블 니트 스웨터', planner: '김지현', styleCode: 'SP25F-KNT-004', factoryName: '탕콤', reorderRound: 0, thisWeekReorderQty: 300, fourWeekReorderQty: 1200,
  ...
  // ── FW25 아우터 ──
  { id: 'D-012', year: 2025, season: 'FW25', garmentType: '아우터', itemName: '헤비 패딩 롱코트', planner: '한도윤', styleCode: 'SP25F-OTR-002', factoryName: '닝보(아이비)', reorderRound: 0, thisWeekReorderQty: 95, fourWeekReorderQty: 380,
  ...
  { id: 'D-013', year: 2025, season: 'FW25', garmentType: '아우터', itemName: '트렌치코트 클래식', planner: '한도윤', styleCode: 'SP25F-OTR-003', factoryName: '탕콤', reorderRound: 0, thisWeekReorderQty: 163, fourWeekReorderQty: 652,
  ...
  // ── SS25 저지 (전년 시즌) ──
  { id: 'D-014', year: 2025, season: 'SS25', garmentType: '저지', itemName: '베이직 라운드 반팔', planner: '박준영', styleCode: 'SP25S-JSY-005', factoryName: '닝보(홍화)', reorderRound: 3, thisWeekReorderQty: 800, fourWeekReorderQty: 3200,
  ...
  { id: 'D-015', year: 2025, season: 'SS25', garmentType: '우븐', itemName: '코튼 치노 쇼츠', planner: '최서윤', styleCode: 'SP25S-WVN-003', factoryName: '탕콤', reorderRound: 2, thisWeekReorderQty: 450, fourWeekReorderQty: 1800,
  ...
  // ── 달성율 200%+ (리오더 확정) ──
  { id: 'D-016', year: 2026, season: 'SS26', garmentType: '저지', itemName: '쿨맥스 기능성 반팔티', planner: '박준영', styleCode: 'SP26S-JSY-003', factoryName: '닝보(홍화)', reorderRound: 3, thisWeekReorderQty: 1200, fourWeekReorderQty: 4800,
  ...
  { id: 'D-017', year: 2026, season: 'SS26', garmentType: '니트류', itemName: '아이스 코튼 반팔니트', planner: '김지현', styleCode: 'SP26S-KNT-003', factoryName: '닝보(아이비)', reorderRound: 2, thisWeekReorderQty: 775, fourWeekReorderQty: 3100,
  ...
  { id: 'D-018', year: 2025, season: 'FW25', garmentType: '우븐', itemName: '기모 체크 셔츠', planner: '이수민', styleCode: 'SP25F-WVN-004', factoryName: '탕콤', reorderRound: 2, thisWeekReorderQty: 713, fourWeekReorderQty: 2852,
