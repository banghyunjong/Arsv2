...
export function DashboardSplitPage() {
  ...
  return (
    <main className="container page">
      ...
      <section>
        <ReorderDetailTable items={detailItems} onToggleReorder={handleToggleReorder} reorderIds={reorderIds} highlightId={highlightRemovedId} yearFilter={yearFilter} onYearChange={setYearFilter} viewportClass="grid-viewport-half" />
      </section>
